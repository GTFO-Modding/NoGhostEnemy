...
{
    internal static class NoGhostEnemyLogger
    {
        private static readonly ManualLogSource _logger;

        static NoGhostEnemyLogger()
        {
            // We create our private logger instance with the plugin name NoGhostEnemy
            _logger = new ManualLogSource("NoGhostEnemy");
